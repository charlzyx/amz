...
import { RelayServerMessage } from '../types/message'
...
export const ChatBox: React.FC = () => {
  ...
  // 处理 relay server 返回的消息
  const handleRelayResponse = (response: RelayServerMessage) => {
  ...
  const sendMessageToRelay = async (message: string): Promise<RelayServerMessage> => {
